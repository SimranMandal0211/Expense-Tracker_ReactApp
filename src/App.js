...
import { doc, collection, addDoc, updateDoc, getDocs, deleteDoc,  onSnapshot } from "firebase/firestore";
...
const reducer = (state, action) => {
  ...
  switch (action.type) {
    ...
    case "UPDATE_EXPENSE": {
      ...
      expensesDuplicate[payload.expenseRef] = payload.expense;
      return {
...
function App() {
  ...
  const updateExpense = async (expense) => {
    ...
    dispatch({ type: "UPDATE_EXPENSE", payload: { expenseRef, expense } });
